...
import { RunEntry, loadJournal, clearJournal, exportJournalFile } from "@/app/lib/runJournal";
    ...
    <div className="rounded-2xl border p-4 shadow-sm space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => { exportJournalFile(); }} className="text-sm underline">Exporter JSON</button>
          <button onClick={() => { clearJournal(); refresh(); }} className="text-sm underline text-red-700">Vider</button>
        </div>
      </div>
