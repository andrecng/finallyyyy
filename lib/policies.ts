...
export const POLICIES: Record<string, Policy> = {
  "ftmo-daily-first": {
    ...
    params: {
      // Marché (tu peux laisser mu_override=0 pour edge nul)
      mu_override: 0.0,
      // Vol targeting
      ...
      // Kelly cap (borne, jamais booster)
      kelly_cap: 0.012,
      // FTMO Gate – daily-first + pacing
  ...
  "ftmo-total-first": {
    ...
    params: {
      ...
      kelly_cap: 0.014,
      dd_total_limit: 0.10, dd_daily_limit: 0.05,
      lmax_mode: "vol", z_var: 2.5, spend_rate: 0.10, safety_buffer: 0.0015, // pacing plus faible ⇒ daily plus permissif
      banned_hours: [[22,23],[0,1]], session_haircut: 0.0,
      gates: { fee_bps_per_step: 0 },
      target: 0.10
    }
